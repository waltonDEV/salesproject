...
public class ImageRemarkUtil {
    ...
    public static void main(String[] args) {
        String srcImgPath = "c:/xuproject/1.jpg";
        String logoText = "复 印 无 效";
        String iconPath = "c:/xuproject/2.jpg";

        String targerTextPath = "c:/xuproject/qie_text.jpg";
        String targerTextPath2 = "c:/xuproject/qie_text_rotate.jpg";

        String targerIconPath = "c:/xuproject/qie_icon.jpg";
        String targerIconPath2 = "c:/xuproject/qie_icon_rotate.jpg";
